...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.BBUI = {}, global.vue));
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock(_component_el_button, vue.mergeProps({ class: "bbui-button" }, _ctx.$attrs, { style: _ctx.btnStyle }), {
      default: vue.withCtx(() => [
  ...
  var script = vue.defineComponent({
      ...
      setup(props, context) {
          ...
          const drawerWidth = vue.ref(props.size);
          // 更改默认值
          const initAttrs = () => {
  ...
  const _withScopeId = n => (vue.pushScopeId("data-v-435a0cfc"),n=n(),vue.popScopeId(),n);
  const _hoisted_1 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("div", null, " . . . ", -1 /* HOISTED */));
  const _hoisted_2 = [
    _hoisted_1
  ];
    ...
    return (vue.openBlock(), vue.createBlock(vue.Teleport, { to: "body" }, [
      vue.createVNode(_component_el_drawer, vue.mergeProps({
        ...
        default: vue.withCtx(() => [
          ...
          vue.createVNode(_component_el_button, { class: "fix-drawer-focus" }),
          vue.createElementVNode("div", {
          ...
          vue.createElementVNode("span", _hoisted_7, null, 512 /* NEED_PATCH */)
        ]),
        _: 3 /* FORWARDED */
  ...
  exports.BBButton = install$2;
  exports.BBDrawerMove = install$1;
